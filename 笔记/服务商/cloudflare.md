...
* cloudflare搭建OneDrive
![CF上的OneDrive](../images/onedrive_0.png)  
[项目地址](https://github.com/heymind/OneDrive-Index-Cloudflare-Worker)
* 新建APP应用(访问[该链接](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RegisteredApps)新建应用)

```
账户    xxxxx@xxxxx.onmicrosoft.com
密码    123321123321
...
const config = {
     ...
     * 放refresh_token
     */
    "refresh_token": "asdffdaasdffdsasdfYQ",
    /**
     * client_id
     */
    "client_id": "123tesdfgwer234",
    /**
     * client_secret
     */
    "client_secret": "asdfqwer12346e54",
    /**
     * 重定向链接不需要改
     */
    "redirect_uri": "https://heymind.github.io/tools/microsoft-graph-api-auth",
    ...
    /**
     * 使用CF代理下载,修改为true后,下载链接加后缀?proxied
     */
    "proxyDownload": true,
};
/**
 * 设置修改为true,登陆时候需要帐号密码.可以自行修改
 */
const AUTH_ENABLED = false
const NAME = "admin"
const PASS = "password"
...
https://www.bilibili.com/video/av89209298/  
